    ...
    <div class=" container-fluid  container-fixed-lg">
      <div class="inner">
        ...
        <ol class="breadcrumb">  
          ...
          <li class="breadcrumb-item active">{{ __('Edit')}} {{ $AdSense->name }}</li>
        </ol>
        <!-- END BREADCRUMB -->
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="pg-image"></i> {{ __('Edit')}} {{ $AdSense->name }}</h3>
              </div>
            </div>
            <!-- END card -->
          </div>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
              ...
              <div class="form-group form-group-default form-group-default-select2 required">
                ...
                <select class="full-width" data-placeholder="Select Location" data-init-plugin="select2" name="Location">
                  ...
                  @if(isset($AdSense->Location))
                   <option value="{{ $AdSense->Location }}">{{ __('Your')}} {{ $AdSense->Location }}</option>
                  @else
                  @endif
                  <!-- ============================================= links Content Start Setting ============================================= -->
            ...
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="ex: This Title Advertisement" name="name" value="{{ $AdSense->name }}">
              @error('name')
            ...
            <p>{{ __('These are Default Advertisement Type')}}</p>
              <div class="form-group form-group-default form-group-default-select2 required">
                ...
                <select class="full-width" data-placeholder="Select Type" data-init-plugin="select2" name="Type">
                  <option value="{{ $AdSense->Type }}">{{ __('Type Is')}} {{ $AdSense->Type }}</option>
                  ...
                  <div id="collapseTwo" class="collapse" role="tabcard" aria-labelledby="headingTwo">
                    <div class="card-body">
                      <div class="form-group form-group-default required">
                        ...
                        <input type="text" class="form-control @error('url') is-invalid @enderror" placeholder="{{ __('ex:  Your Url Image')}}" value="{{ $AdSense->url }}" name="url"> 
                      </div>
                    </div>
                  </div>
                </div>
