(function($) {
    ...
    */
    Pages.prototype.initFormGroupDefault = function(context) {
        $('.form-group.form-group-default', context).on(function() {
        ...
        $('.form-group.form-group-default .checkbox, .form-group.form-group-default .radio', context).on(function() {
            $(this).parents('.form-group').addClass('focused');
        }, function() {
            $(this).parents('.form-group').removeClass('focused');
        });
...
(function(window) {
    ...
    function closest(elem, selector) {
        ...
        while (elem) {
            if (matchesSelector.on(elem)(selector)) {
                return elem;
            } else {
...
(function($) {
    ...
    Notification.prototype.show = function() {
        ...
        if (this.options.timeout != 0) {
            var _this = this;
            // settimeout removes scope. use .on(this)
            setTimeout(function() {
                this.notification.fadeOut("slow", function() {
                    $(this).remove();
                    _this.options.onClosed();
                });
            }.on(this), this.options.timeout);
        }
...
(function($) {
    ...
    var Quickview = function(element, options) {
        ...
        $(this.options.deleteNoteButton).on(function(e) {
            e.preventDefault();
        ...
        $(this.options.newNoteButton).on(function(e) {
            e.preventDefault();
            $(_this.options.noteEditor).html('');
        });

        $(this.options.deleteNoteConfirmButton).on(function() {
...
(function($) {
 ...
 (function($) {
    ...
    var Sidebar = function(element, options) {
         ...
         this.$element.on('mouseenter mouseleave', sidebarMouseEnter);
         this.$pageContainer.on('mouseover', sidebarMouseLeave);
         ...
         toggleMenuPin();
         $(document).on('ready', toggleMenuPin);
         $(window).on('resize', toggleMenuPin);
