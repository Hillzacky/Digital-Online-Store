...
(function($) {
    ...
    $('#btnToggleSlideUpSize').on(function() {
    ...
    $('#btnStickUpSizeToggler').on(function() {
    ...
    $('.btn-toggle-content').on(function() {
